...
/// [CustomIconListPopupMenuItem]), or no value at all (for example, [CustomIconListPopupMenuDivider]).
///
/// See also:
///
///  * [CustomIconListPopupMenuItem], a popup menu entry for a single value.
///  * [CustomIconListPopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedCustomIconListPopupMenuItem], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
abstract class CustomIconListPopupMenuEntry<T> extends StatefulWidget {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const CustomIconListPopupMenuEntry({Key? key}) : super(key: key);
...
/// See also:
///
///  * [CustomIconListPopupMenuItem], for the kinds of items that this widget divides.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CustomIconListPopupMenuDivider extends CustomIconListPopupMenuEntry<Never> {
  /// Creates a horizontal divider for a popup menu.
  ///
  /// By default, the divider has a height of 16 logical pixels.
  const CustomIconListPopupMenuDivider(
  ...
  @override
  _CustomIconListPopupMenuDividerState createState() =>
      _CustomIconListPopupMenuDividerState();
}

class _CustomIconListPopupMenuDividerState
    extends State<CustomIconListPopupMenuDivider> {
  @override
...
/// [CheckedCustomIconListPopupMenuItem].
///
/// Typically the [child] of a [CustomIconListPopupMenuItem] is a [Text] widget. More
/// elaborate menus with icons can use a [ListTile]. By default, a
/// [CustomIconListPopupMenuItem] is [kMinInteractiveDimension] pixels high. If you use a widget
...
///
/// ```dart
/// const CustomIconListPopupMenuItem<WhyFarther>(
...
/// complete menu, and see the example at [CheckedCustomIconListPopupMenuItem] for one way to
/// keep the text of [CustomIconListPopupMenuItem]s that use [Text] widgets in their [child]
/// slot aligned with the text of [CheckedCustomIconListPopupMenuItem]s or of [CustomIconListPopupMenuItem]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [CustomIconListPopupMenuDivider], which can be used to divide items from each other.
///  * [CheckedCustomIconListPopupMenuItem], a variant of [CustomIconListPopupMenuItem] with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CustomIconListPopupMenuItem<T> extends CustomIconListPopupMenuEntry<T> {
  /// Creates an item for a popup menu.
  ///
  /// By default, the item is [enabled].
  ///
  /// The `enabled` and `height` arguments must not be null.
  const CustomIconListPopupMenuItem({
    Key? key,
    this.value,
    this.enabled = true,
  ...
  @override
  CustomIconListPopupMenuItemState<T, CustomIconListPopupMenuItem<T>> createState() =>
      CustomIconListPopupMenuItemState<T, CustomIconListPopupMenuItem<T>>();
}

/// The [State] for [CustomIconListPopupMenuItem] subclasses.
///
/// By default this implements the basic styling and layout of Material Design
/// popup menu items.
///
/// The [buildChild] method can be overridden to adjust exactly what gets placed
/// in the menu. By default it returns [CustomIconListPopupMenuItem.child].
///
/// The [handleTap] method can be overridden to adjust exactly what happens when
/// the item is tapped. By default, it uses [Navigator.pop] to return the
/// [CustomIconListPopupMenuItem.value] from the menu route.
///
/// This class takes two type arguments. The second, `W`, is the exact type of
/// the [Widget] that is using this [State]. It must be a subclass of
/// [CustomIconListPopupMenuItem]. The first, `T`, must match the type argument of that widget
/// class, and is the type of values returned from this menu.
class CustomIconListPopupMenuItemState<T, W extends CustomIconListPopupMenuItem<T>>
    extends State<W> {
  /// The menu item contents.
  ///
  /// Used by the [build] method.
  ///
  /// By default, this returns [CustomIconListPopupMenuItem.child]. Override this to put
  ...
  ///
  /// By default, uses [Navigator.pop] to return the [CustomIconListPopupMenuItem.value] from
  /// the menu route.
  @protected
  void handleTap() {
...
/// shows a popup menu, consider using [PopupMenuButton].
///
/// A [CheckedCustomIconListPopupMenuItem] is kMinInteractiveDimension pixels high, which
/// matches the default minimum height of a [CustomIconListPopupMenuItem]. The horizontal
...
///     CheckedCustomIconListPopupMenuItem<Commands>(
///       checked: _heroAndScholar,
///       value: Commands.heroAndScholar,
///       child: const Text('Hero and scholar'),
///     ),
///     const CustomIconListPopupMenuDivider(),
///     const CustomIconListPopupMenuItem<Commands>(
...
/// See also:
///
///  * [CustomIconListPopupMenuItem], a popup menu entry for picking a command (as opposed to
///    toggling a value).
///  * [CustomIconListPopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CheckedCustomIconListPopupMenuItem<T> extends CustomIconListPopupMenuItem<T> {
  ...
  const CheckedCustomIconListPopupMenuItem({
    Key? key,
    T? value,
    this.checked = false,
    bool enabled = true,
  ...
  @override
  _CheckedCustomIconListPopupMenuItemState<T> createState() =>
      _CheckedCustomIconListPopupMenuItemState<T>();
}

class _CheckedCustomIconListPopupMenuItemState<T>
    extends CustomIconListPopupMenuItemState<T, CheckedCustomIconListPopupMenuItem<T>>
...
class _PopupMenuRoute<T> extends PopupRoute<T> {
  ...
  final RelativeRect position;
  final List<CustomIconListPopupMenuEntry<T>> items;
...
Future<T?> showMenu<T>({
  ...
  required List<CustomIconListPopupMenuEntry<T>> items,
  T? initialValue,
  double? elevation,
...
/// argument is the value of the [CustomIconListPopupMenuItem] that caused its menu to be
/// dismissed.
///
/// Used by [PopupMenuButton.onSelected].
typedef CustomIconListPopupMenuItemSelected<T> = void Function(T value);
...
typedef CustomIconListPopupMenuItemBuilder<T> = List<CustomIconListPopupMenuEntry<T>>
...
///  * [CheckedCustomIconListPopupMenuItem], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
class CustomIconListPopupMenuButton<T> extends StatefulWidget {
  /// Creates a button that shows a popup menu.
  ///
  /// The [itemBuilder] argument must not be null.
  const CustomIconListPopupMenuButton({
    Key? key,
  ...
  final CustomIconListPopupMenuItemBuilder<T> itemBuilder;
  ...
  /// called instead.
  final CustomIconListPopupMenuItemSelected<T>? onSelected;
  ...
  @override
  CustomIconListPopupMenuButtonState<T> createState() =>
      CustomIconListPopupMenuButtonState<T>();
}
...
class CustomIconListPopupMenuButtonState<T>
    extends State<CustomIconListPopupMenuButton<T>> {
  ...
  void showButtonMenu() {
    ...
    final List<CustomIconListPopupMenuEntry<T>> items = widget.itemBuilder(context);
