...
class SideMenuItemExpanded extends StatefulWidget {
  ...
  const SideMenuItemExpanded({Key? key , required this.item , required this.isActive , required this.onTap , required this.isExpanded}) : super(key: key);
...
class _SideMenuItemExpandedState extends State<SideMenuItemExpanded> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
        ...
        child: Container(
          color: widget.isActive ? active.withOpacity(0.04) : Colors.transparent,
            child: Padding(
          ...
          height: 18,
                ...
                Visibility(visible: widget.isExpanded , child: SingleChildScrollView( child :Text(
                    widget.item.name,
                    style: TextStyle(
                        color: widget.isActive ? active : onHover,
                        fontSize: 12,
                  ...
                  Container(width: 2, height: 50, color: widget.isActive ? active : Colors.transparent,),
                ],
              ),
            )));
  }
