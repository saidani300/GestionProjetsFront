...
List<ViewItem> views = [
  ...
  ViewItem("Tableau", "icons/views/table.svg"),
];

class TaskShowByViewMenu extends StatefulWidget {
  const TaskShowByViewMenu({Key? key}) : super(key: key);

  @override
  _TaskShowByViewMenuState createState() => _TaskShowByViewMenuState();
}

class _TaskShowByViewMenuState extends State<TaskShowByViewMenu> {
