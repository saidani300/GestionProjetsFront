...
class _EventItemState extends State<EventItem>   with AutomaticKeepAliveClientMixin<EventItem> ,TickerProviderStateMixin {
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              child: Row(
                                children: [
                                  SvgPicture.asset(
                                    widget.event.eventType == EventType.Opportunity ?  "icons/up-arrow.svg" : "icons/down-arrow.svg",
                                    color: widget.event.eventType == EventType.Opportunity ? lightBlue : lightRed,
                                    width: 20,
                                    height: 20,
                                  ...
                                  SizedBox(width: 5),
                                  Visibility(visible: widget.event.documents.isNotEmpty, child: CustomIconButton(icon: Icons.attach_file_rounded, message: "${widget.event.documents.length.toString()} Attachement", onTap: (){}, size: 15,)),
                                ],
                              ),
                            ),
                            flex: 3,
                          ...
                          Expanded(
                            child: Container( child :
                            Row( children :[ CustomTag(text: widget.event.evaluations.length.toString() + " Évaluations", color: text,),])
                            ),
                            flex: 2,
                          ),
                          SizedBox(
                          ...
                          Expanded(
                            child: Row(
                                ...
                                children: [
                                  Container(
                                      child: LevelTag(level: widget.event.level,))
                                ]),
                            flex: 1,
                          ),
                          // ActionsMenu(),
                          ...
                          Container(width: 40, child: Row(mainAxisSize: MainAxisSize.min,children: [
                            ...
                            CustomIconButton(
                                ...
                                onTap: () {
                                  _controller.reverse().whenComplete(() => bloc.remove(widget.event));
...
class LevelTag extends StatelessWidget {
  ...
  const LevelTag({Key? key, required this.level})
      : super(key: key);
