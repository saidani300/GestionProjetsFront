...
class EventOrderBy extends StatefulWidget {
  ...
  @override
  _EventOrderByState createState() => _EventOrderByState();
}

class _EventOrderByState extends State<EventOrderBy> {
  String orderBy = eventOrderByAsText(eventListOrder.orderBy);
          ...
          return [
            CustomIconListPopupMenuItem(
                ...
                child: Container(
                    height: 161,
                    width: 180,
                    child:EventOrderByListView(onSelectPropriety: (String value) { setState(() {orderBy = value;}); },
...
class EventOrderByListView extends StatefulWidget {
  final Function(String value) onSelectPropriety;
  final Function(bool value) setAscending;
  const EventOrderByListView({Key? key,required this.onSelectPropriety , required this.setAscending}) : super(key: key);

  @override
  _EventOrderByListViewState createState() => _EventOrderByListViewState();
}

class _EventOrderByListViewState extends State<EventOrderByListView> {
  bool isAscending = eventListOrder.isAscending;
  @override
  Widget build(BuildContext context) {
      ...
      child: ListView(
          ...
          children: [
            ListTile(
              ...
              onTap: () async {
                eventListOrder.isAscending = true;
                setState(() {
                  isAscending = true;
                });
                bloc.fetch();
            ...
            ListTile(
              ...
              onTap: () async {
                eventListOrder.isAscending = false;
                setState(() {
                  isAscending = false;
                });
                bloc.fetch();
            ...
            ...EventOrderByProperties.values
                .map((e) {
              bool isChecked = eventListOrder.orderBy == e;
              return ListTile(
                contentPadding:
                ...
                onTap: () async {
                  widget.onSelectPropriety(eventOrderByAsText(e));
                  eventListOrder.orderBy = e;
                  setState(() {
                    isChecked = true;
                  });
                  bloc.fetch();
