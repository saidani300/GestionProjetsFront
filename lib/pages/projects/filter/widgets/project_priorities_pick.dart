...
class ProjectPrioritiesPicker extends StatefulWidget {
  final double widgetHeight;
  const ProjectPrioritiesPicker({
    Key? key,
    this.widgetHeight = 40,
  }) : super(key: key);

  @override
  _ProjectPrioritiesPickerState createState() => _ProjectPrioritiesPickerState();
}

class _ProjectPrioritiesPickerState extends State<ProjectPrioritiesPicker>{
                ...
                CustomListPopupMenuItem(
                    ...
                    child: Container(
                        ...
                        child: BlocProvider<ProjectFilterBloc>(
                            ...
                            child: ProjectPrioritiesListView(Priority.values,filterBloc))))
                ];
              });
  }
}

class ProjectPrioritiesListView extends StatefulWidget {
  final List<Priority> priorities;
  final ProjectFilterBloc bloc;
  ProjectPrioritiesListView(this.priorities , this.bloc) ;

  @override
  _ProjectPrioritiesListViewState createState() => _ProjectPrioritiesListViewState();
}

class _ProjectPrioritiesListViewState extends State<ProjectPrioritiesListView>{
                    ...
                    leading: Transform.scale(
                      ...
                      child: Checkbox(
                        ...
                        onChanged: (value) {
                          ...
                          {
                            projectFilter.priorities = [];
                            widget.bloc.fetch();
                          }
                          else{
                              projectFilter.priorities = List.from(Priority.values);
                              widget.bloc.fetch();
                          }
                          projectFilter.allPriorities = eq(filter.priorities, Priority.values);
                        },
                        activeColor: active,
                      ),
                    ),
                    ...
                    leading: Transform.scale(
                      ...
                      child: Checkbox(
                        value: (snapshot.hasData)
                            ...
                            : true,
                        onChanged: (value) {
                          projectFilter.priorities.contains(e)
