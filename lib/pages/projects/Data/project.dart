...
class Project {
  ...
  priority =  Priority.values.elementAt(json['priority']),
   documents = List<Document>.from(json["documents"].map((x) => Document.fromJson(x))).toList();
...
List<Project> projects = [
  Project(
      ...
      Status.inProgress,
      DateTime.now(),
      DateTime.now().add(Duration(days: 38)) , Priority.Normal , []),
  Project(
      59898,
      "Développement d'une nouvelle interface utilisateur",
      projectTypesList.first,
      ...
      DateTime.now().add(Duration(days: 1)), Priority.Normal, []),
  Project(
      5,
      "Développement d'une nouvelle interface utilisateur",
      projectTypesList.first,
      ...
      DateTime.now().subtract(Duration(days: 38)), Priority.Important, []),
  Project(
      447,
      "Développement d'une nouvelle interface utilisateur",
      projectTypesList.first,
      ...
      Status.inProgress,
      DateTime.now(),
      DateTime.now().add(Duration(days: 38)), Priority.Low, []),
  Project(
      87789,
      "Développement d'une nouvelle interface utilisateur",
      projectTypesList.first,
      ...
      Status.completed,
      DateTime.now(),
      DateTime.now().add(Duration(days: 150)), Priority.Normal, []),
  Project(
      55558888,
      "Projet Qalitas",
      projectTypesList.first,
